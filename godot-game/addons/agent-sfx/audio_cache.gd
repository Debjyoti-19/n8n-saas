...
var cache_dir: String = "res://.godot/agent_sfx_cache/"
...
func _save_cache():
	...
	var cache_path = cache_dir.trim_prefix("res://")
	var dir = DirAccess.open("res://")
	if dir and not dir.dir_exists(cache_path):
		var parts = cache_path.split("/")
		var current_path = ""
		for part in parts:
			if part.is_empty():
				continue
