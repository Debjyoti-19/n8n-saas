      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Powering multi-agent automation for developers{" "}
              <span
              ...
              >
                with seamless Cline CLI and n8n integration through MCP protocol.
              </span>
            </h2>
            ...
            >
              The first platform that connects Cline with n8n workflows, enabling you to build complex multi-agent
              systems with simple prompts and deploy them with a single click.
            </p>
